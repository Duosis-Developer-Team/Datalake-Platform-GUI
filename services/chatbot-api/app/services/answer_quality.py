...
NARRATIVE_RETRY_PROMPT = (
    ...
    "(1-3 cümle). Kritik sayıları cümle içinde ver. Tablo yalnızca gerekirse ve 4+ satır varsa "
    "cevabın SONUNDA opsiyonel ek olsun; asla yalnızca tablo döndürme."
)
