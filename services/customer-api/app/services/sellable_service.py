...
"""
    ...
    def _apply_host_based_constraints(
        ...
        *,
        ...
        for h in host_rows:
            ...
            stor_used = convert_unit(
                float(h.get("stor_used_host_gb") or h.get("stor_used_gb") or 0.0),
                sto_conv,
            )
    ...
    def compute_panel(
        ...
        *,
        ...
        if (
            selected_clusters
            and panel.family in _FAMILY_COMPUTE_ENDPOINT
            and not skip_cluster_compute
        ):
