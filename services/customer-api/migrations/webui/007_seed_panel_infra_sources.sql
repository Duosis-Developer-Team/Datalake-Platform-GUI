...
VALUES
    ...
    -- Klasik Mimari (VMware datacenter rollup)
    ('virt_classic_cpu', '*',
        'mv_vmware_datacenter_latest', 'total_cpu_ghz',     'GHz',
        'vm_metrics',                  'number_of_cpus',    'vCPU',
        'datacenter_name ILIKE :dc_pattern',
        'VMware DC GHz capacity converted to vCPU via gui_unit_conversion.', 'seed'),
    ('virt_classic_ram', '*',
        'mv_vmware_datacenter_latest', 'total_memory_gb',   'GB',
        'vm_metrics',                  'total_memory_capacity_gb', 'GB',
        'datacenter_name ILIKE :dc_pattern',
        '', 'seed'),
    ('virt_classic_storage', '*',
        'vmhost_metrics',              'total_capacitygb',  'GB',
