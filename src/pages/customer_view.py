...
def _customer_content(customer_name: str, time_range: dict | None = None):
    ...
    overage_loss = _total_overage_loss_tl(eff_by_cat)
    compliance_stub = {
        "summary": {
            "has_overuse": overage_loss > 0,
            "total_overage_loss_tl": overage_loss,
        }
    }
    ...
    return {
        "intro_card": build_crm_context_card(name, sales_summary, compliance_payload=compliance_stub),
