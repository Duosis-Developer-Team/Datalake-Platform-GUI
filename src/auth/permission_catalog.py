                ...
                children=[
                    ...
                    _n(
                        ...
                        children=[
                            ...
                            _n("sub:dc_view:net:backbone", "Backbone Interfaces", "sub_section"),
                            _n("sub:dc_view:net:leaf", "Leaf Data Ports", "sub_section"),
                            _n("sub:dc_view:net:spine", "Spine Interconnect", "sub_section"),
                            _n("sub:dc_view:net:management", "Management Ports", "sub_section"),
                            _n("sub:dc_view:net:shared", "Shared Ports", "sub_section"),
