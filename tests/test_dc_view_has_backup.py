...
def _patch_api(nb=None, zerto=None, veeam=None):
    """api_client'ın üç wrapper'ını test için patch'le."""
    return (
...
def _call(nb=None, zerto=None, veeam=None, dc_id="DC13"):
    p_nb, p_z, p_v = _patch_api(nb=nb, zerto=zerto, veeam=veeam)
    with p_nb, p_z, p_v:
