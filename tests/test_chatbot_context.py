...
def test_extract_context_main_routes():
    assert extract_context("/customers", "", {}, None)["page_title"] == "Müşteri Listesi"
    assert extract_context("/availability-annual", "", {}, None)["page_title"] == "Yıllık Erişilebilirlik"
    assert extract_context("/region-drilldown", "?region=TR", {}, None)["page_title"] == "Bölge Detayı"
    assert extract_context("/administration/integrations/hmdl", "", {}, None)["page_title"] == "Yönetim / Ayarlar"
